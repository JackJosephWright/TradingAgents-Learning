#!/usr/bin/env python3
"""
Multi-Stock Portfolio Analysis - Quick Demo (3 stocks)
Analyzes 3 stocks quickly to demonstrate the system
"""
...
# Quick demo portfolio - just 3 stocks
PORTFOLIO = {
    "Technology": ["NVDA"],  # AI/GPU leader
    "Finance": ["JPM"],       # Traditional banking
    "Consumer": ["KO"]        # Defensive/stable
}
...
def save_results(results, portfolio_summary, filename="portfolio_analysis_quick.json"):
    """
...
def main():
    ...
    """
    print("="*70)
    print("MULTI-STOCK PORTFOLIO ANALYSIS - QUICK DEMO")
    print("="*70)
    ...
    print(f"Expected time: ~{len(all_tickers) * 4} minutes\n")
    ...
    print("\n" + "="*70)
    print("QUICK DEMO ANALYSIS COMPLETE")
    print("="*70)
    print("\nTo analyze the full 10-stock portfolio, run:")
    print("  python multi_stock_analysis.py")
